                            ...
                            <form id="myForm" action="{{ route('product.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="best_seller"  value="1" type="checkbox" id="formCheck" >
                                        <label class="form-check-label" for="formCheck">Best Seller</label>

                                    </div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="most_popular"  value="1" type="checkbox" id="formCheck" >
