                                    ...
                                    <div class="d-flex align-items-start mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <div class="avatar-xl me-3">
                                                <img src="{{ (!empty($profile_data->photo )) ? url('upload/client_images/'.$profile_data->photo) : url('upload/no_image.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="name" type="text" value="{{$profile_data->name}}" id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <select name="city_id"  class="form-select">
                                                ...
                                                @foreach($city as $cit)
                                                    <option value="{{$cit->id}}" {{ $cit->id == $profile_data->city_id ? 'selected' : '' }} >{{$cit->city_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shop_info" id="basicpill-address-input" class="form-control" rows="2" placeholder="Enter your Restaurant Info">{{ $profile_data->shop_info }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <img id="showImage" src="{{ (!empty($profile_data->cover_photo )) ? url('upload/client_images/'.$profile_data->cover_photo) : url('upload/no_image.jpg') }}" alt="" class=" p-1 bg-gray-800" width="210" height="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="mb-3">
                                            <img id="showImage" src="{{ (!empty($profile_data->photo )) ? url('upload/client_images/'.$profile_data->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
                                        </div>
                                        <div class="mt-4">
