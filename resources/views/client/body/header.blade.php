    ...
    <div class="navbar-header">
                ...
                <a href="{{ route('client.dashboard') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                                    <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                         height="24"> <span class="logo-txt">Client</span>
                                </span>
                </a>
        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="#!" class="small text-reset text-decoration-underline"> Unread ({{$ncount}}
                                    )</a>
                            </div>
                        </div>
                    </div>
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        @foreach($client->notifications as $notification)
                            ...
                            <a href="{{ route('all.client.orders') }}" class="text-reset notification-item">
                                <div class="d-flex {{$notification->read_at ? 'notification-read' : 'notification-unread'}}" onclick="markNotificationRead('{{$notification->id}}')">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="font-size-13 text-muted">
                                            <p class="mb-0"><i class="mdi mdi-clock-outline"></i> <span>{{ Carbon\Carbon::parse($notification->created_at)->diffForHumans() }} </span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            @php
                ...
                $profile_data = App\Models\Client::find($id);
            @endphp
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                         src="{{ (!empty($profile_data->photo )) ? url('upload/client_images/'.$profile_data->photo) : url('upload/no_image.jpg') }}"
                         alt="Header Avatar">
...
<script>
    function markNotificationRead(notificationId){
        fetch('/mark-notification-as-read-client/'+notificationId,{
            method: 'POST',
            headers: {
