...
<nav class="navbar navbar-expand-lg navbar-light bg-light osahan-nav shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ route('index') }}"><img alt="logo" src="{{ asset('frontend/img/logo-menu.png') }}" style="height: 65px; width: 65px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="{{ route('list.restaurants') }}" role="button" aria-haspopup="true" aria-expanded="false">
                        Restaurants
                    </a>
                </li>
                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img alt="Generic placeholder image" src="{{ (!empty($profile_data->photo )) ? url('upload/user_images/'.$profile_data->photo) : url('upload/no_image.jpg') }}"  class="nav-osahan-pic rounded-pill"> My Account
                        </a>
                ...
                <li class="nav-item dropdown dropdown-cart">
                    ...
                    <div class="dropdown-menu dropdown-cart-top p-0 dropdown-menu-right shadow-sm border-0">
                        ...
                        @foreach($groupedCart as $clientId => $item)
                            @if(isset($clients[$clientId]))
                                @php
                                    $client = $clients[$clientId];
                                @endphp
                                <div class="dropdown-cart-top-header p-4">
                                    <img class="img-fluid mr-3" alt="different" src="{{ asset('upload/client_images/' . $client->photo) }}">
                        ...
                        <div class="dropdown-cart-top-footer border-top p-4">
                            <p class="mb-0 font-weight-bold text-secondary">Total <span class="float-right text-dark">{{ $total }} мкд</span></p>
                        </div>
