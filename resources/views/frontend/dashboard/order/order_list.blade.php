                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-between">
                                                        <a href="{{ route('user.order_details', $item->id) }}"
                                                           class="btn-small d-block text-primary"><i class="fas fa-eye"></i> View</a>
                                                        <a href="{{ route('user.invoice.download', $item->id) }}"
                                                           class="btn-small d-block text-danger"><i class="fa fa-download"></i> Invoice</a>
