                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mt-3 mt-lg-0">
                                                        ...
                                                        <div class="mb-3">
                                                            <img id="showImage" src="{{ (!empty($profile_data->photo )) ? url('upload/user_images/'.$profile_data->photo) : url('upload/no_image.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
                                                        </div>
                                                        <div class="mt-4">
