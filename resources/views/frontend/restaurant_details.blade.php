...
<section class="restaurant-detailed-banner">
    <div class="text-center">
        <img class="img-fluid cover" src="{{ asset('upload/client_images/'.$restaurant->cover_photo) }} ">
    </div>
            ...
            <div class="row d-flex align-items-end">
                <div class="col-md-8">
                    <div class="restaurant-detailed-header-left">
                        <img class="img-fluid mr-3 float-left" alt="osahan" src="{{ asset('upload/client_images/'.$restaurant->photo) }} ">
                        ...
                        <p class="text-white mb-0"><i class="icofont-food-cart"></i>{{ $menu_names_string }}
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
...
{{--restaurant info--}}
                        <div class="tab-pane fade" id="pills-restaurant-info" role="tabpanel" aria-labelledby="pills-restaurant-info-tab">
                            <div id="restaurant-info" class="bg-white rounded shadow-sm p-4 mb-4">
                                ...
                                <p class="mb-2 text-black"><i class="icofont-clock-time text-primary mr-2"></i>{{ $restaurant->shop_info}}
