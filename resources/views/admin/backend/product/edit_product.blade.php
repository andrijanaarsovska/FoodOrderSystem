                            ...
                            <form id="myForm" action="{{ route('admin.product.update') }}" method="post"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="client_id"  class="form-select">
                                                ...
                                                @foreach($client as $clt)
                                                    <option value="{{$clt->id}}" {{ $clt->id == $product->client_id ? 'selected' : '' }}>{{$clt->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="best_seller"  value="1" type="checkbox" id="formCheck"  {{ $product->best_seller == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="formCheck">Best Seller</label>

                                    </div>
                                    <div class="form-check mt-2">
                                        <input class="form-check-input" name="most_popular"  value="1" type="checkbox" id="formCheck" {{ $product->most_popular == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="formCheck">Most Popular</label>
