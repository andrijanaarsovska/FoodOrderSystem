                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($order->status == 'pending')
                                                <a href="{{ route('pending_to_confirm', $order->id) }}" class="btn btn-block btn-info" id="confirmOrder">Confirm Order</a>
                                            @elseif($order->status == 'confirmed')
                                                <a href="{{ route('confirm_to_processing', $order->id) }}"  class="btn btn-block btn-warning" id="processOrder">Process Order</a>
                                            @elseif($order->status == 'processing')
                                                <a href="{{ route('processing_to_deliver', $order->id) }}" class="btn btn-block btn-success" id="deliverOrder">Deliver Order</a>
                                            @endif
                                        </td>
                                    </tr>
                                    </tbody>
