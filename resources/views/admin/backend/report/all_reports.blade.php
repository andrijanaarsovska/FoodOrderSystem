                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <form id="myForm" action="{{ route('admin.search.date') }}" method="post"
                                    ...
                                    <div class="col-sm-4">
                                        <form id="myForm" action="{{ route('admin.search.month') }}" method="post"
                                              enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <form id="myForm" action="{{ route('admin.search.year') }}" method="post"
                                              enctype="multipart/form-data">
                                            @csrf
